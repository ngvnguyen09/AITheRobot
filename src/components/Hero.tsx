      ...
      <div className="w-full md:w-1/2 flex flex-col gap-6 z-10 pt-10 md:pt-0">
        ...
        >
          ...
          <h1 className="text-5xl lg:text-7xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-gray-200 to-gray-500">
            HỆ SINH THÁI AI <br />
            TUYỂN SINH <span className="text-primary-500">THÔNG MINH</span>
          </h1>
        </motion.div>
        ...
        >
          Giải pháp công nghệ tập trung hóa dữ liệu, đánh giá mức độ rủi ro và cá nhân hóa chiến lược tuyển sinh lớp 10 tại TP.HCM. Tích hợp Robot Creeper 1M3 và AI Chatbot.
        </motion.p>
